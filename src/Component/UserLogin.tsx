...
export default function UserLogin() {
  ...
  const handleAppleLogin = () => {
    toast.info("Apple login requires Apple Developer configuration. Apple token flow to be implemented here.");
    // handleSocialLogin("apple", "apple_id_token_here", "First", "Last");
  };
